...
class Transaction(models.Model):
    ...
    transaction_from = models.ForeignKey(Person, on_delete=models.CASCADE,related_name="transaction_from")
    transaction_to = models.ForeignKey(Person,on_delete=models.CASCADE,related_name="transaction_to")
